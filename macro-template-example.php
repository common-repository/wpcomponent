...
{"type": "id", "name": "Id", "slug": "id", "exclude": "attachment, post"}
{"type": "color", "name": "Color", "slug": "color"}
{"type": "number", "name": "Number", "slug": "myNumber"}
{"type": "option", "name": "Option couleur", "slug": "color"}
{"type": "option-number", "name": "Color option", "slug": "optionNumber"}
{"type": "option-switch", "name": "Switch option", "slug": "optionSwitch"}
{"type": "option-color", "name": "Color option", "slug": "colorOption"}
{"type": "option-select", "name": "Select option", "slug": "colorSelect", "choice": "test, test2, test3"}
---------------------------------------------------------------------
*/
/*
==============================================================================
