...
Description: WP Component enable component for web worker.
Version: 2.2.4
...
// Folder name
define ( 'WPCOMPONENT_VERSION', '2.2.4' );
...
class wpcomponent_kickstarter
{
    ...
    public function wpcomponent_register_plugins(){
        ...
        $scripts[] = array(
            'handle'    => 'qtip2',
            'src'       => WPCOMPONENT_URL . '/static/qtip.js',
            'deps'      => array('jquery')
        );
        $scripts[] = array(
            'handle'    => 'switchery',
            'src'       => WPCOMPONENT_URL . '/static/switchery.js',
            'deps'      => array('jquery')
        );
		$scripts[] = array(
			'handle'	=> 'wpcomponent-js',
			'src'		=> WPCOMPONENT_URL . '/front/javascripts/wpcomponent.js',
			'deps'		=> array('jquery', 'qtip2', 'wp-color-picker', 'switchery')
		);
    ...
    public function wpcomponent_register_styles(){
		...
		$styles[] = array(
			...
			'src'		=> WPCOMPONENT_URL . '/front/stylesheets/wpcomponent.css'
		);
