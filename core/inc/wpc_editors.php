...
class wpcomponent_editors
{
    ...
    public function getNewColor()
    {
    	...
    	<div class="wpc_element-input wp-core-ui wp-title-wrap">
    		<div class="inner">
					...
					<input type="text" id="<?=$this->container_id?>_color" name="wpcomponent_color_[]" value="<?=$this->content?>" class="text wpcomponent-color-picker">
    	...
    	<div class="wpc_element-input wp-core-ui wp-title-wrap">
    		<div class="inner">
				<?php
					...
					?>
                    <input type="hidden" class="switch-hidden" name="wpcomponent_optionswitch_[]" value="<?=$switchValue?>">
    ...
    public function getNewID()
    {
        ...
        $wpc_structure = new wpcomponent_Structure();
        $filter_options = explode(',', str_replace(' ','',$wpc_structure->wpcomponent_getIdOption( $this->folder_type, $this->folder, $this->file, $this->slug ) ) );
		...
		foreach ( $post_types as $post_type ) {
            ...
            if( true == in_array( $post_type->name, $filter_options ) )
                continue;
    		...
    		<div class="inner">
					...
					<?php
						...
						switch ( trim($type) ) {
							...
							case 'color':
							?>
								<input type="text" name="wpcomponent_optioncolor_[]" value="<?=$this->content?>" class="text wpcomponent-color-picker">
							<?php
								break;
