...
class wpcomponent_post
{
	...
	public function wpcomponent_save( $post_id ) {
			...
			&& !empty( $_POST['metabox_id'] ) && is_array($_POST['metabox_id'])){
				...
				if( !empty( $_POST['wpcomponent_color_'] ) && is_array($_POST['wpcomponent_color_']) ){
					$wpc_colors = array_map( array( "wpcomponent_utility", "sanitizeHexColor" ), $_POST['wpcomponent_color_']);
				}
				...
				if( !empty( $_POST['wpcomponent_optioncolor_'] ) && is_array($_POST['wpcomponent_optioncolor_']) ){
					$wpc_optionscolor = array_map( array( "wpcomponent_utility", "sanitizeHexColor" ), $_POST['wpcomponent_optioncolor_']);
				}
					...
					foreach ($wpc_metabox as $key_meta => $metabox) {
							...
							foreach( $metabox_structure as $key => $element ):
								...
								switch ( $element->type ) {
									...
									case 'color':
										$wpc_newpost['post_content'] = $wpc_colors[ $i_color ];
										$i_color++;
										$i_fields++;
										break;
									...
									case 'option-color':
										$wpc_newpost['post_content'] = $wpc_optionscolor[ $i_optioncolor ];
										$i_optioncolor++;
										$i_options++;
										break;
